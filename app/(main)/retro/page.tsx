        ...
        <>
            <div className={"hero"}>
                <div className={"hero-content text-center"}>
                    <div>
                        <h1 className={"mt-5 text-5xl font-bold underline underline-offset-8"}>Kỷ niệm</h1>
            ...
            <div className={"mx-14 flex flex-col flex-wrap content-center justify-center gap-y-8"}>
                <Link
                    ...
                    className={"card lg:card-side h-60 shadow-md hover:border-1 hover:border-gray-400"}
                >
                    <figure>
                    ...
                    <div className={"card-body"}>
                        ...
                        <p>Offline đầu tiên của VNS, cũng như là tiền đề cho Dreamchasers và VNS Network.</p>
                    </div>
                </Link>
                {/*<Link*/}
                {/*    href={"/"}*/}
