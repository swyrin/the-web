...
export default function AboutDreamchasers() {
    return (
        <div className={"flex place-content-center-safe"}>
            <div className={"max-w-screen p-10 sm:w-150 md:w-200 lg:w-250"}>
                ...
                <div className={"items-center font-normal"}>
                    ...
                    <ul className={"ml-10 list-disc space-y-5"}>
                        <li>
                            ...
                            Hypergryph (dưới tên Terra Historicus) hoặc fanart cộng đồng. Ngoài ra, page thỉnh thoảng
                            cũng sẽ cập nhật & chia sẻ các nội dung, tin tức liên quan đến Arknights.
                        </li>
                        <li>
